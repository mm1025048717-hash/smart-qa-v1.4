...
const FUZZY_RULES: MatchRule[] = [
  ...
  { keywords: ['为什么', '下降'], scenarioId: 'L2-25', priority: 11, mustIncludeAll: true },
  { keywords: ['下降', '原因'], scenarioId: 'L2-25', priority: 11, mustIncludeAll: true },
  { keywords: ['转化率', '偏低'], scenarioId: 'L2-26', priority: 11, mustIncludeAll: true },
  { keywords: ['利润', '下滑'], scenarioId: 'L2-27', priority: 11, mustIncludeAll: true },
  ...
  { keywords: ['产品'], scenarioId: 'L2-08', priority: 3 },
  { keywords: ['品类'], scenarioId: 'L2-08', priority: 3 },
