      ...
      {steps.map((step, index) => {
        ...
        return (
          <motion.div
            ...
            className="bg-white rounded-xl border border-[#E5E5EA] p-4 shadow-sm hover:shadow-md transition-shadow"
          >
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-[#007AFF] to-[#5856D6] flex items-center justify-center text-white text-sm font-semibold">
                {index + 1}
              </div>
              <div className="flex-1 min-w-0">
                ...
                {isSQLBlock ? (
                  ...
                  <div className="text-[14px] text-[#2d2d2f] leading-relaxed">
                    {renderInlineMarkdown(content)}
                  </div>
                )}
              </div>
